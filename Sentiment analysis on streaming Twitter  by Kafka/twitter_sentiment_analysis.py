...
def write_row_in_mongo(df, epoch_id):
    mongoURL = "mongodb+srv://user:password@cluster0.gpc4m.mongodb.net/demo_database.demo_collection?retryWrites=true&w=majority"
...
if __name__ == "__main__":
    spark = SparkSession \
        ...
        .config("spark.mongodb.input.uri",
                "mongodb+srv://user:password@cluster0.gpc4m.mongodb.net/demo_database.demo_collection?retryWrites=true&w=majority") \
        .config("spark.mongodb.output.uri",
                "mongodb+srv://user:password@cluster0.gpc4m.mongodb.net/demo_database.demo_collection?retryWrites=true&w=majority") \
        .config("spark.jars", "/Users/benminh1201/spark/spark-3.2.1-bin-hadoop2.7/jars/mongo-spark-connector-10.0.0.jar") \
        .config("spark.jars","/Users/benminh1201/spark/spark-3.2.1-bin-hadoop2.7/jars/spark-streaming-kafka-0-10-assembly_2.12-3.2.1.jar") \
        .config("spark.jars","/Users/benminh1201/spark/spark-3.2.1-bin-hadoop2.7/jars/spark-sql-kafka-0-10_2.12-3.2.1.jar") \
        .getOrCreate()
